...
function Maze_Wall:OnSpawn(params)
    Log("OnInit is running");
    local model = params or self.Properties.object_Model;
    self.Properties.object_Model = model;
    self.Model = model;
...
function Maze_Wall:SetModelDimensions(Dims)
